...
cd /app/src/applets/SmartPGP && JC_HOME=/app/sdks/jc304_kit ant convert && cp /app/src/applets/SmartPGP/target/*.cap /app/src/bin/

echo "Compiling vk-ykhmac"
cd /app/src/applets/vk-ykhmac && ant dist && cp /app/src/applets/vk-ykhmac/target/*.cap /app/src/bin/
cd /app/src/applets/vk-ykhmac/tools/yktool && make yktool.jar && cp /app/src/applets/vk-ykhmac/tools/yktool/yktool.jar /app/src/bin/
